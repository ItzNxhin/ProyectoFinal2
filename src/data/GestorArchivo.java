...
/**
 * Esta clase gestiona los datos de usuario almacenados en un archivo.
 */
public class GestorArchivo {

    /**
     * Este método agrega nuevos usuarios al archivo.
	...
	public static void agregarDatos(Usuario usuario) {
		try {
			...
			// Guarda el nuevo ArrayList que contiene la información del nuevo usuario y
			// usuarios anteriores
     ...
     * @return verdadero si el inicio de sesión es exitoso, falso en caso contrario.
     */
	@SuppressWarnings("unchecked")
	public static boolean iniciarSesion(String correo, String contrasena) {
		try {
			...
			/*
			 * Luego de leer el archivo y almacenar los datos tal como el metodo anterior,
			 * el programa empieza a recorrer el ArrayList buscando un correo que coincida
			 * con el correo que se le paso como parametro, si el programa encuentra una
			 * coincidencia, pasa a evaluar la contraseña; si la contraseña es correcta
			 * guarda la posicion del usuario y crea la ventana "Saludo".
			 */
	...
	// Metodo para verificar si un correo ya existen en la base de datos (Archivo
	// serializable)
	@SuppressWarnings("unchecked")
	public static boolean existeCorreo(String correo) {
		try {
			...
			// Si no encuentra ninguna coincidencia, retorna false indicando que el correo
			// no existe
			return false;
		} catch (Exception e) {
